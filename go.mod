...
// rclone v1.75.0 pulls a temporary grpc v1.84.0-dev; pin stable until rclone releases with stable grpc.
replace google.golang.org/grpc => google.golang.org/grpc v1.83.2

// tyler-smith/go-bip39 removed upstream; mirror with matching module path.
replace github.com/tyler-smith/go-bip39 => github.com/BlackDark/go-bip39 v1.1.0-csi.1

// Defensive fh/nodeIndex guards (CSI RWX). Fork keeps hanwen module path.
// https://github.com/BlackDark/fork-go-fuse/releases/tag/v2.12.0-csi.5
replace github.com/hanwen/go-fuse/v2 => github.com/BlackDark/fork-go-fuse/v2 v2.12.0-csi.5
